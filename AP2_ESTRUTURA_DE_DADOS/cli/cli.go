...
func opcoes() {
	...
	fmt.Println("5 - Buscar produto por nome;")
	fmt.Println("6 - Exibir todos os produtos ordenados por ID;")
	fmt.Println("7 - Exibir todos os produtos ordenados por nome;")
	fmt.Println("8 - Adicionar pedido;")
	fmt.Println("9 - Expedir pedido;")
	fmt.Println("10 - Exibir métricas do sistema;")
...
func atualizarProdutoId() {
	...
	nome := leTexto("Novo nome do produto (pressione 0 para manter o mesmo): ")
	descricao := leTexto("Nova descrição (pressione 0 para manter o mesmo): ")
	novoPreco := leFloat("Novo preço do produto (pressione 0 para manter o mesmo): ")
